...
for i in range (1 , number_of_images ):
    ...
    ret, corners = cv2.findChessboardCorners(gray, (width, height ) , cv2 .CALIB_CB_ADAPTIVE_THRESH +
...
ret , K , D , _ , _ = cv2.fisheye.calibrate(objpoints, imgpoints, image_size, K, D, rvecs, tvecs, calibration_flags,
...
for i in range(1, number_of_images):
    ...
    combined = np.hstack((img, undistorted_image))
